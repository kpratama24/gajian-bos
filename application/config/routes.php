...
$route['histori'] = 'C_Homepage/loadHistoriPage';
$route['detHistori'] = 'C_Histori';
$route['detail/(:any)'] = 'C_DaftarGaji/loadDetailLaporan/$1';
$route['input'] = 'C_Input/index';
$route['gajian'] = 'C_Input/inputGaji';
$route['laporan'] = 'C_DaftarGaji/index';
$route['remove'] = 'C_DaftarGaji/remove';
$route['gaji/(:any)'] = 'C_DaftarGaji/viewLaporan/$1';
