    ...
    <html lang="en">
      ...
      <div class="container">
        <div class="jumbotron">
            ...
            if($this->session->userdata('role') == 1){
            	?>
            	<a href="<?php echo base_url();?>histori"><button class="btn btn-outline-primary">Lihat Histori Laporan Tenaga Magang</button></a>&nbsp; &nbsp; 
            	<?php
            }
            ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h3>Informasi</h3>
        <hr>
        <p><?php echo $this->session->flashdata('edit'); ?></p>
      </div>
    </div>
